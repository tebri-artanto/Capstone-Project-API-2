...
const pathKey = path.resolve('/capstone-project-387217-3c13c63e22f6.json')
...
const postArtikel = async (req, res) => {
    ...
    try{
        ...
        const artikelUrl = `https://storage.googleapis.com/${bucket.name}/${blob.name.toLowerCase().split(" ").join("-")}`;
